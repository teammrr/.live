...
<div class="flex flex-col gap-4 lg:flex-row items-center justify-center h-screen" >
    ...
    <ProjectsList title={"Book-It"} description={"Small side project which I've intended to provide convenience for student to book a meeting room at school. "} link={"https://timetabs.teamrr.live"} repo={"https://github.com/teammrr/timetabs-react"} />
</div>